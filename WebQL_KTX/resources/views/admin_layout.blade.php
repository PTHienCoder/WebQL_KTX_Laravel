        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
			   <li class="sub-menu">
				...
				<li class="sub-menu">
                    <a href="{{URL::to('/qly-sinhvien-admin')}}">
                        <i class="fa fa-book"></i>
			   ...
			   <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Quản lý cán bộ ký túc xá</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{URL::to('/add-canboktx')}}">Thêm tài khoản</a></li>
						<li><a href="{{URL::to('all-canbo')}}">Danh sách tài khoản</a></li>
				...
				<li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Quản lý Khu ký túc xá</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{URL::to('/add-khuktx')}}">Thêm Khu</a></li>
						<li><a href="{{URL::to('/all-khu')}}">Danh sách khu KTX</a></li>
                    </ul>
                </li>
				<li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Quản lý phòng ký túc xá</span>
                    </a>
                    <ul class="sub">
						<li><a href="{{URL::to('/add-phongktx')}}">Thêm phòng</a></li>
						<li><a href="{{URL::to('/all-phong')}}">Danh sách phòng KTX</a></li>
                    </ul>
                </li>
				<li class="sub-menu">
                    <a href="{{URL::to('/add-thong-bao')}}">
                        <i class="fa fa-book"></i>
 ...
 <!-- footer -->
		  <!-- <div class="footer">
			<div class="wthree-copyright" style="text-align: center;">
			  <p>© 2022 Visitors. All rights reserved | Design by <a href="http://w3layouts.com"><b>Na Na</b></a></p>
			</div>
		  </div> -->
  <!-- / footer -->
</section>
