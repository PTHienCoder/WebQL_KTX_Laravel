...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Ban quản lý Ký túc xá</title>
...
<body>
	<!-- <div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="{{asset('public/backend/logo.png')}}" alt=""></div>
				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="{{asset('public/backend/logo.png')}}" alt="">
						</span>
						<span class="user-name"> 	<?php
							$name = Session::get('name_ql');
							$idkhu = Session::get('idkhu');
							$mauser = Session::get('maql');
							$id = Session::get('id_ql');
							if($name){
								echo $name;
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						...
						<a class="dropdown-item" href="{{URL::to('/logout-CBQL')}}"><i class="dw dw-logout"></i> Log Out</a>
					</div>
				</div>
			</div>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
				...
				<img style="height: 40px; width: auto;" src="{{asset('public/backend/logo-truong-250.png')}}" alt="" class="light-logo">
				&ensp; ĐH SPKT DN</a>
		...
		<div class="menu-block customscroll">
			...
			<ul id="accordion-menu">
					<li class="dropdown">
						<a href="{{URL::to('/dashboard-CBQL/'.$mauser)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Home</span>
						</a>
				
					</li>
					<li>
						<a href="{{URL::to('/DanhSanhPhong-sinhvien-Dangky/'.$idkhu)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Duyệt hồ sơ</span>
						</a>
					</li>
					<li>
						<a href="{{URL::to('/Danh-HoSo-GiaHan/'.$idkhu)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Hồ sơ gia hạn</span>
						</a>
					</li>
					<li>
						<a href="{{URL::to('/Danh-SV-ChuyenPhong/'.$idkhu)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">SV chuyển phòng</span>
						</a>
					</li>
					<li>
						<a href="{{URL::to('/Danh-SV-TraPhong/'.$idkhu)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">SV trả phòng</span>
						</a>
					</li>
					<li>
						<a href="{{URL::to('/QLy-Phong/'.$idkhu)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Quản lý Phòng</span>
						</a>
					</li>
				 <li>
						<a href="{{URL::to('/QLy-SV/'.$idkhu)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Quản lý SV</span>
						</a>
					</li>
