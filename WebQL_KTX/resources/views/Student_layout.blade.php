			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						...
						<a class="dropdown-item" href="{{URL::to('/logout-sinhvien')}}"><i class="dw dw-logout"></i> Log Out</a>
					</div>
				</div>
			</div>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li class="dropdown">
						<a href="{{URL::to('/DB-sinhvien/'.$mauser)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-house-1"></span><span class="mtext">Home</span>
						</a>
				
					</li>
					<li>
						<a href="{{URL::to('/phonghientai/'.$mauser)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Phòng ở hiện tại</span>
						</a>
					</li>
					<li>
						<a href="{{URL::to('/DanhSanhPhong-sinhvien/'.$gt)}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Đăng ký Phòng</span>
						</a>
					</li>
					<li>
						<a href="{{URL::to('/DanhSanh-Qly-KTX')}}" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Thông tin CBQL</span>
						</a>
					</li>
