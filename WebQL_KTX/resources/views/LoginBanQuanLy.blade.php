...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Login with Quản lý</title>
			...
			<div class="row align-items-center">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form action="{{URL::to('/login-CBQL')}}" method="post">
							...
							<div class="select-role">
								<div class="btn-group btn-group-toggle" data-toggle="buttons">
									<label class="btn active">
										...
										<div class="icon"><img src="{{asset('public/backend/vendors/images/briefcase.svg')}}" class="svg" alt=""></div>
										<span>Tôi là</span>
										Cán bộ quản lý KTX
									</label>
								</div>
