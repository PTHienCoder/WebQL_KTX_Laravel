					...
					<div class="container pd-0">
						<div class="row">
												...
												<div class="col-lg-8 col-md-12 col-sm-12">
													<div class="blog-caption">
														...
														<div class="blog-by">
														   ...
														   <div class="pt-10">
																<a href="{{URL::to('/update-profile-student/'.$cate->id)}}" class="btn btn-outline-primary">Cập nhật thông tin</a>
															</div>
														</div>
													</div>
												</div>
							...
							<div class="col-md-4 col-sm-12">
								...
								<div class="card-box mb-30">
									<h5 class="pd-20 h5 mb-0">Thông báo cá nhân</h5>
									<div class="latest-post">
									<ul>
											@foreach($all_no2 as $key => $cate)
											<li>
												<h4><a href="#">{{$cate->title}}</a></h4>
												<p>{!!$cate->mota!!}: {{$cate->price}} </p>
												<span><?php
													Carbon::setLocale('vi');
													$dt2 = Carbon::create($cate->time);								 
													$now = Carbon::now('Asia/Ho_Chi_Minh');						
