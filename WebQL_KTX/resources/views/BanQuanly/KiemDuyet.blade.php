       ...
       <div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Danh sách hồ sơ đăng ký nội trú chờ phê duyệt online</h4>
						</div>
					...
					<table class="table">
						...
						@foreach($allphong as $key => $cate)
							...
							<tr>		
								...
								<td>
								<a href="{{URL::to('/chitiet-phieudangky/'.$cate->id_phieu)}}" class="btn btn-primary">Chi tiết</a>
								</td>
							 </tr>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Danh sách hồ sơ đăng ký nội trú chờ phê duyệt tại phòng quản lý</h4>
						</div>
						<!-- <div class="pull-right">
							<a href="#basic-table" class="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button"><i class="fa fa-code"></i> Source Code</a>
						</div> -->
					...
					<table class="table">
						...
						@foreach($allphong2 as $key => $cate)
						 ...
						 <td>{{$cate->giaphong}}</td>
								...
								<form action="{{URL::to('/pheduyet-offline')}}" method="post">
                               {{ csrf_field() }}
